...
if(isset($_POST['confirm2FA'])) {
    $ziffer1 = $_POST['ziffer1'];
    $ziffer2 = $_POST['ziffer2'];
    $ziffer3 = $_POST['ziffer3'];
    $ziffer4 = $_POST['ziffer4'];
    $ziffer5 = $_POST['ziffer5'];
    $ziffer6 = $_POST['ziffer6'];

    $otp_code = $ziffer1.$ziffer2.$ziffer3.$ziffer4.$ziffer5.$ziffer6;

    //get otp sceret from database
    $otp_secret = $db->getOTPsecretFromUser();
    ...
    if($otp->verify($otp_code)) {
        ...
        $db->continueLogin($browser, $device);
...
<head>
    ...
    <title>Zwei-Faktor Authentifizierung - ide4school</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bolder mb-1">Hi, <?=$getCurrentUserData['firstName']?>!</h2>
                                <p class="card-text mb-75">Bitte gebe jetzt deinen Authentifizierungscode aus deiner Zwei-Faktor App (z.B. den Google Authenticator) ein.</p>
                                <form class="mt-2" action="2fa" method="POST">
                                    <h6>6-stelliger Code:</h6>
                                    <div class="auth-input-wrapper d-flex align-items-center justify-content-between">
                                        <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="ziffer1" type="text" maxlength="1" autofocus="" />
                                        <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="ziffer2" type="text" maxlength="1" />
                                        <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="ziffer3" type="text" maxlength="1" />
                                        <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="ziffer4" type="text" maxlength="1" />
                                        <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="ziffer5" type="text" maxlength="1" />
                                        <input class="form-control auth-input height-50 text-center numeral-mask mx-25 mb-1" name="ziffer6" type="text" maxlength="1" />
                                    </div>
                                    <?php if($error == 1) {
                                        echo '<p style="color:red;">Der eingegebene Code ist falsch!</p>';
                                    }
                                    ?>
                                    <button class="btn btn-primary w-100" type="submit" name="confirm2FA" tabindex="4">Einloggen</button>
                                </form>
                                <p class="text-center mt-2"><span>Kein Zugriff mehr auf deine Zwei-Faktor App?</span><br /><span>Bitte deinen Schuladministrator darum deine Zwei-Faktor Methode zu entfernen, um dich wieder anzumelden.</span></a></p>
                            </div>
                        </div>
                    </div>
                </div>

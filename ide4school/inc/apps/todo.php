...
if($db->getCurrentUserInformations()['role'] == "Schüler") {
    if($db->isListenModeOn()) {
        header("Location: focus_lobby&return_to=todo");
    }
}


if($db->isTodoFunktionEnabled() == false) {
...
if($getCurrentUserData['role'] == "Schüler") {
    $todos = $db->getTodosFromFolder($current_folder);
}
else {
    $todos = $db->getAllTodos($current_folder, $_SESSION['currentSessionClass']);
}
          ...
          if($db->createTodo($titel, $sender, $zuteilung, $fertig, $description, $class, $log_user)) {
            header("Location: todo");
                ...
                <div class="alert alert-danger" role="alert">
                                                    ...
                                                    Todo konnte nicht erstellt werden! Bitte versuchen Sie es nocheinmal oder kontaktieren Sie support@ide4school.com
                                                    </div>
                                                </div>';
            }
    };
        ...
        if($db->completeTodo($id)) {
            header("Location: todo");
                ...
                <div class="alert alert-danger" role="alert">
                                                    <h4 class="alert-heading">Datenbankfehler</h4>
                                                    <div class="alert-body">
                                                    Todo konnte nicht als "erledigt" markiert werden! Bitte versuchen Sie es nocheinmal oder kontaktieren Sie support@ide4school.com
                                                    </div>
                                                </div>';
            }
    };
        ...
        if($db->deleteTodo($id)) {
            header("Location: todo");
                ...
                <div class="alert alert-danger" role="alert">
                                                    <h4 class="alert-heading">Datenbankfehler</h4>
                                                    <div class="alert-body">
                                                    Todo konnte nicht als "gelöscht" markiert werden! Bitte versuchen Sie es nocheinmal oder kontaktieren Sie support@ide4school.com
                                                    </div>
                                                </div>';
            }
    };

        if(isset($_POST["recoverTodo"]))
        {

        $id = $_POST['todo-id'];

        // Insert in DB and create Todo
        if($db->recoverTodo($id)) {
            header("Location: todo");
            }
            else {
                echo'
                <div class="alert alert-danger" role="alert">
                                                    <h4 class="alert-heading">Datenbankfehler</h4>
                                                    <div class="alert-body">
                                                    Todo konnte nicht als "Zu erledigen" markiert werden! Bitte versuchen Sie es nocheinmal oder kontaktieren Sie support@ide4school.com
                                                    </div>
                                                </div>';
            }
        };
...
<head>
    ...
    <title>Aufgaben - <?php echo $db->getCurrentInstitution() ?> - ide4school</title>
...
<!-- Session class update hidden form -->
        <form action="todo" method="POST" id="updateSessionClassForm">
...
<?php  
                ...
                if($db->isTodoFunktionEnabled()) {
                    echo '<li class=" nav-item active"><a class="d-flex align-items-center" href="todo"><i data-feather="check-square"></i><span class="menu-title text-truncate" data-i18n="Todo">Todo</span></a>
                    </li>';
                }
                ...
                <div class="sidebar">
                    <div class="sidebar-content todo-sidebar">
                        <div class="todo-app-menu">
                                ...
                                <?php
                                if($db->noStudent()) {
                                    echo '<div class="add-task"><button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#new-task-modal">
                                    Aufgabe hinzufügen
                                </button></div>';
                                }
                                ?>
                            ...
                            <div class="sidebar-menu-list">
                                <div class="list-group list-group-filters">
                                    <a href="todo&folder=inbox" class="list-group-item list-group-item-action <?php if($current_folder == "inbox") { echo 'active'; } ?>">
                                        <i data-feather="mail" class="font-medium-3 me-50"></i>
                                        <span class="align-middle">Offene Aufgaben</span>
                                    </a>
                                    <a href="todo&folder=completed" class="list-group-item list-group-item-action <?php if($current_folder == "completed") { echo 'active'; } ?>">
                                        <i data-feather="check" class="font-medium-3 me-50"></i> <span class="align-middle">Erledigt</span>
                                    </a>
                                    <a href="todo&folder=deleted" class="list-group-item list-group-item-action <?php if($current_folder == "deleted") { echo 'active'; } ?>">
                                        <i data-feather="trash" class="font-medium-3 me-50"></i> <span class="align-middle">Gelöscht</span>
                                    </a>
                                </div>
            ...
            <div class="content-right">
                <div class="content-wrapper container-xxl p-0">
                            ...
                            <div class="todo-task-list-wrapper list-group">
                                <ul class="todo-task-list media-list" id="todo-task-list">
                                    ...
                                    foreach($todos as $todo) {
                                        echo'
                                            <li class="todo-item" data-bs-toggle="modal" data-bs-target="#view-task-modal-id' . $todo['id'] . '">
                                                <div class="todo-title-wrapper">
                                                    <div class="todo-title-area">
                                                    ...
                                                    <div class="todo-item-action">
                                                        <div class="badge-wrapper me-1">
                                                            <span class="badge rounded-pill badge-light-primary">' . $todo['due_date'] . '</span>
                                                        </div>
                                                        <small class="text-nowrap text-muted me-1">Von ' . $todo['sender'] . '</small>
                                                        <div class="avatar">
                        ...
                        <div class="modal modal-slide-in sidebar-todo-modal fade" id="new-task-modal">
                            <div class="modal-dialog sidebar-lg">
                                <div class="modal-content p-0">
                                    <form id="form-modal-todo" class="todo-modal needs-validation" action="todo" method="POST">
                                        ...
                                        <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                            <div class="action-tags">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="todoTitleAdd" name="todo-titel" class="new-todo-item-title form-control" placeholder="Titel" />
                                                </div>
                                                <div class="mb-1 position-relative">
                                                    <label for="task-assigned" class="form-label d-block">Zuteilen an</label>
                                                    <select class="select2 form-select" id="todo-zuteilung" name="todo-zuteilung">
                                                ...
                                                <div class="mb-1">
                                                    <label for="task-due-date" class="form-label">Erledigen bis</label>
                                                    <input type="datetime-local" class="form-control task-due-date" id="task-due-date" placeholder="Zeitpunkt festlegen" value="2022-09-01T14:30" name="todo-due-date" />
                                                </div>
                                                
                                                <div class="mb-1">
                                                    <label class="form-label">Beschreibung</label>
                                                    <textarea rows="3" class="form-control task-description" id="task-due-date" placeholder="Beschreibe die Aufgabe..." name="todo-description"></textarea>
                                                </div>
                                            </div>
                                            <div class="mb-1">
                                                <button type="submit" name="createTodo" value="createTodo" class="btn btn-primary  add-todo-item me-1">Hinzufügen</button>
                    ...
                    foreach($todos as $todo) {
                        ...
                        <div class="modal modal-slide-in sidebar-todo-modal fade" id="view-task-modal-id' . $todo['id'] . '">
                            <div class="modal-dialog sidebar-lg">
                                <div class="modal-content p-0">
                                    <form id="form-modal-todo" class="todo-modal needs-validation" action="todo" method="POST">
                                        <div class="modal-header align-items-center mb-1">
                                            <h5 class="modal-title">Aufgabe ansehen</h5>
                                            <div class="todo-item-action d-flex align-items-center justify-content-between ms-auto">
                                                <i data-feather="x" class="cursor-pointer" data-bs-dismiss="modal" stroke-width="3"></i>
                                            </div>
                                        </div>
                                        <div class="modal-body flex-grow-1 pb-sm-0 pb-3">
                                            <div class="action-tags">
                                                <div class="mb-1">
                                                    <label for="todoTitleAdd" class="form-label">Titel</label>
                                                    <input type="text" id="todoTitleAdd" name="todo-titel" class="new-todo-item-title form-control" placeholder="Titel" value="' . $todo['title'] . '" readonly/>
                                                </div>
                                                <div class="mb-1 position-relative">
                                                    <label for="task-assigned" class="form-label d-block">Zugeteilt an</label>
                                                    <input type="text" id="todoTitleAdd" name="todo-zuteilung" class="new-todo-item-title form-control" placeholder="Zugeteilt an" value="' . $todo['receiver'] . '" readonly/>
                                                </div>
                                               
                                                <div class="mb-1">
                                                    <label for="task-due-date" class="form-label">Zu erledigen bis</label>
                                                    <input type="datetime-local" class="form-control task-due-date" id="task-due-date" placeholder="Zeitpunkt festlegen" value="' . $todo['due_date'] . '" name="todo-due-date" readonly/>
                                                </div>
                                                
                                                <div class="mb-1">
                                                    <label class="form-label">Beschreibung</label>
                                                    <textarea rows="3" class="form-control task-description" id="task-due-date" name="todo-description" readonly>' . $todo['text'] . '</textarea>
                                                </div>
                                            </div>
                                            <input type="hidden" value="' . $todo['id'] . '" name="todo-id" readonly hidden/>
                                            <div class="mb-1">
                                            ';
                                            if($current_folder != "inbox" && $getCurrentUserData['role'] != "Schüler") {
                                                echo '<button type="submit" name="recoverTodo" value="recoverTodo" class="btn btn-primary add-todo-item me-1">Als offen markieren</button>';
                                            }
                                            if($current_folder == "inbox" && $getCurrentUserData['role'] != "Schüler") {
                                                echo '<button type="submit" name="completeTodo" value="completeTodo" class="btn btn-primary add-todo-item me-1">Als erledigt markieren</button>';
                                            }
                                            if($current_folder != "deleted" && $getCurrentUserData['role'] != "Schüler") {
                                                echo '<button type="submit" name="deleteTodo" class="btn btn-outline-secondary add-todo-item ">Löschen</button>';
                                            }
                                                echo '
                                            </div>
                                        </div>

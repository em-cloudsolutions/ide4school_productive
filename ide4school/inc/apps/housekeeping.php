...
if(isset($_POST['clearAllMessages'])) {
    $db->clearAllMessages();
}
...
<head>
    ...
    <title>Housekeeping - <?=$db->getCurrentInstitution();?> - ide4school</title>
...
<script>
    ...
    function clearAllMessages(){
        document.getElementById("clearAllMessagesForm").submit();
    }

    function clearAllMails(){
        document.getElementById("clearAllMailsForm").submit();
    } 

    function clearAllNotifications(){
        document.getElementById("clearAllNotificationsForm").submit();
    } 
...
<!-- Session class update hidden form -->
        ...
        <form action="housekeeping" method="POST" id="clearAllMessagesForm">
            <input name="clearAllMessages" type="text" hidden id="clearAllMessages">
        </form>

        <form action="housekeeping" method="POST" id="clearAllMailsForm">
            <input name="clearAllMails" type="text" hidden id="clearAllMails">
        </form>

        <form action="housekeeping" method="POST" id="clearAllNotificationsForm">
            <input name="clearAllNotifications" type="text" hidden id="clearAllNotifications">
        </form>

        <form action="housekeeping" method="POST" id="clearAllLogsForm">
            <input name="clearAllLogs" type="text" hidden id="clearAllLogs">
        </form>
...
?>
         ...
         <li class=" nav-item active"><a class="d-flex align-items-center" href="housekeeping"><i data-feather="wind"></i><span class="menu-title text-truncate" data-i18n="Housekeeping">Housekeeping</span></a>
         </li>
         <?php
                        }
                        ?>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header float-start mb-0">Housekeeping - <?=$db->getCurrentInstitution();?></h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                ...
                <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title"><span class="badge rounded-pill badge-light-danger">Gefahrenzone</span></h4>
                            </div>
                            <div class="card-body my-2 py-25">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button OnClick="clearAllToDos()" class="btn btn-primary me-1 mt-1" >
                                            ToDo's löschen
                                        </button>
                                        <br /><br /><hr><br /><br />
                                        <div class="mb-1">
                                            <h5>Mitteilungen löschen</h5>
                                            <span>Mit einem Klick auf diesen Button können Sie ALLE Mitteilungen aus sämtlichen Klassen löschen.</span>
                                            <br />
                                            <span style="color: red;">Diese Aktion kann nicht rückgängig gemacht werden!</span>
                                            </div>
                                                                            
                                        <button OnClick="clearAllMessages()" class="btn btn-primary me-1 mt-1" >
                                            Mitteilungen löschen
                                        </button>
                                        <br /><br /><hr><br /><br />
                                        <div class="mb-1">
                                            <h5>E-Mails löschen</h5>
                                            <span>Mit einem Klick auf diesen Button können Sie ALLE E-Mails sämtlicher Benutzer löschen.</span>
                                            <br />
                                            <span style="color: red;">Diese Aktion kann nicht rückgängig gemacht werden!</span>
                                            </div>
                                                                            
                                        <button OnClick="clearAllMails()" class="btn btn-primary me-1 mt-1" >
                                            E-mails löschen
                                        </button>
                                        <br /><br /><hr><br /><br />
                                        <div class="mb-1">
                                            <h5>Benachrichtigungen löschen</h5>
                                            <span>Mit einem Klick auf diesen Button können Sie ALLE Benachrichtigungen sämtlicher Benutzer löschen.</span>
                                            <br />
                                            <span style="color: red;">Diese Aktion kann nicht rückgängig gemacht werden!</span>
                                            </div>
                                                                            
                                        <button OnClick="clearAllNotifications()" class="btn btn-primary me-1 mt-1" >
                                           Benachrichtigungen löschen
                                        </button>
                                        <br /><br /><hr><br /><br />
                                        <div class="mb-1">
                                            <h5>Systemlogs leeren</h5>
                                            <span>Mit einem Klick auf diesen Button können Sie ALLE Einträge des Systenlogs löschen.</span>
                                            <br />
                                            <span style="color: red;">Diese Aktion kann nicht rückgängig gemacht werden!</span>
                                            </div>
                                                                            
                                        <button OnClick="clearAllLogs()" class="btn btn-primary me-1 mt-1" >
                                           Logs leeren
                                        </button>

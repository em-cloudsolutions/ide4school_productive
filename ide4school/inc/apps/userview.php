                ...
                <section class="app-user-view-account">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                            <!-- Levies table -->
                            <div class="card">
                                <h4 class="card-header">Noch nicht zurückgegebene Abgaben dieses Benutzers:</h4>
                                <div class="table-responsive">
                                    <table class="table datatable-project">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            if(!$levies) {
                                                echo '<td>Keine Abgaben</td>';
                                            }
                                            else {
                                            foreach($levies as $levy) {
                                                echo '<td><a href="submission&id=' . $levy['id'] . '">' . $levy['name'] . '</a></td>';
                                                echo '<td>' . $levy['date'] . '</td>';
                                            }
                                        }
                                            ?>
                                            </tbody>

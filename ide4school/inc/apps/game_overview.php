...
$games = $db->getAllEnabledGames();

function generateGameToken() {
    $new_game_token = substr(md5(mt_rand()), 0, 64);
    return $new_game_token;
}

if(isset($_POST['startGame'])) {
    $game_id = $_POST['game_id_start'];
    $game_token = generateGameToken();
        if($db->createNewGameSession($game_id, $game_token)) {
            ...
            <div class="alert alert-danger" role="alert">
                                                ...
                                                Spiel konnte nicht gestartet werden! Bitte versuchen Sie es nocheinmal oder kontaktieren Sie support@ide4school.de
                                                </div>
                                            </div>';
        }
}
...
<head>
    ...
    <title>Spiele - <?=$getCurrentUserData['institution']?> - ide4school</title>
...
<script>
    ...
    function startGame(game_id){
        document.getElementById("game_id_start").value = game_id;
...
<!-- Session class update hidden form -->
        <form action="games" method="POST" id="updateSessionClassForm">
            <input name="class_name" type="text" hidden id="class_name">
            <input name="updateSessionClass" type="text" hidden id="updateSessionClass">
        </form>

        <form action="games" method="POST" id="startGameForm">
            <input name="game_id_start" type="text" hidden id="game_id_start">
            <input type="hidden" name="startGame" hidden>
        </form>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                if($db->isGameFunktionEnabled()) {
                    ...
                    <ul class="menu-content ">
                        <li><a class="d-flex align-items-center active" href="games"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Spieleübersicht">Spieleübersicht</span></a>
                        </li>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header float-start mb-0">Spiele - <?=$getCurrentUserData['institution']?></h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body my-2 py-25">
                                <div class="row">
                                    <div>
                                        <div class="mb-6 pb-80">
                                            Lehrer haben die Möglichkeit bestimmte (Lern-)spiele für die Nutzung innerhalb des Unterrichts freizugeben. Der Lehrer erstellt dazu eine Spielsession und sendet anschließend Einladungen an die Schüler. Diese können anschließend dem Spiel beitreten und warten, bis der Lehrer das Spiel startet.
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">Spiel auswählen</h4><br />
                            </div>
                            <div class="card-body my-1 py-25">
                            <p class="text-truncate"><b>Wählen Sie ein Spiel aus, dass Sie für Ihre Schüler bereitstellen wollen.</b></p>
                                <div class="row gx-4">
                                    <div class="col-lg-12">
                            ...
                            <table class="table text-nowrap text-center border-bottom">
                                <thead>
                                    <tr>
                                        <th class="text-start">Spielname</th>
                                        <th>Aktion</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php
                                        ...
                                        echo '<tr>
                                        <td class="text-start"><b>' . $game['name'] . '</b><br /><br /><p class="text-truncate"><i>Beschreibung: ' . $game['description'] . '</i></p></td>
                                        <td>
                                        <button OnClick="startGame(`'.$game['id'].'`)" type="button" class="btn btn-icon btn-outline-primary waves-effect">
                                ...
                                if($games == NULL) {
                                    echo '<tr><td>Keine Spiele freigegeben.</td></tr>';
                                }

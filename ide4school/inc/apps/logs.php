    ...
    if($db->deleteAllLogs()) {
        ...
        echo'
            <div class="alert alert-danger" role="alert">
                                                ...
                                                Protokoll konnte nicht geleert werden! Bitte versuchen Sie es nocheinmal oder kontaktieren Sie support@ide4school.com
                                                </div>
                                            </div>';
        sleep(3);
        header("Location: logs");
...
<head>
    ...
    <title>Logs - <?=$getCurrentUserData['institution']?> - ide4school</title>
...
<form action="logs" method="POST" id="updateSessionClassForm">
            <input name="class_name" type="text" hidden id="class_name">
            <input name="updateSessionClass" type="text" hidden id="updateSessionClass">
        </form>

        <form action="logs" method="POST" id="deleteAllLogsForm">
            <input name="deleteAllLogs" type="text" hidden id="deleteAllLogs">
        </form>
...
<?php  
         ...
         <?php
                ...
                <li class=" nav-item active"><a class="d-flex align-items-center" href="logs"><i data-feather="server"></i><span class="menu-title text-truncate" data-i18n="Logs">Logs</span></a>
         </li>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header float-start mb-0">Logs - <?=$getCurrentUserData['institution']?></h2>
                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="card-text">
                                    Hier sehen Sie die Logs Ihrer Schule:
                                <button onclick="deleteLogs()" style="width: 260px; float: right; margin-left: 13px; margin-top: 15px;" type="button" class="btn btn-primary">Gesamtes Protokoll löschen</button><br />
                                </p>
                            </div>
